...
Public Const gmsgUnlockAskActiveContentMod As String = "The active book is modified. You can't put the changes into the repository by realeasing lock. Do you continue?"
