...
Public Const gmsgCommitAskSaveMod As String = "アクティブブックには変更があります。上書き保存しますか？"
Public Const gmsgCommitAskSaveModCloseReopen As String = "コミット時に、ファイルをいったん閉じて再度開きます。アクティブブックには変更があります。上書き保存しますか？"
...
Public Const gmsgAskSaveMod As String = "アクティブブックには変更があります。上書き保存しますか？"
Public Const gmsgAskLockMod As String = "SVN管理下のロック属性付アクティブブックに変更があります。ロックを取得しますか?ロックを取得すると今行った変更は破棄されます。"
