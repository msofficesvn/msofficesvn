...
Public Const gmsgCommitAskSaveMod As String = "アクティブ文書には変更があります。上書き保存しますか？"
Public Const gmsgCommitAskSaveModCloseReopen As String = "コミット時に、ファイルをいったん閉じて再度開きます。アクティブ文書には変更があります。上書き保存しますか？"
...
Public Const gmsgAskLockMod As String = "SVN管理下のロック属性付アクティブ文書に変更があります。ロックを取得しますか?ロックを取得すると今行った変更は破棄されます。"
