...
Public Const gmsgErrActiveContentFileNotExist As String = "Le fichier du document actif n’a pas été trouvé. Veuillez enregistrer le document et réeessayer."
