...
Public Const gmsgUpdateAskActiveContentMod As String = "The active document is modified. Do you abort updating? If you select [No], the changes are discarded and continue to update."
Public Const gmsgCommitErrActiveContentFileReadOnly As String = "Can't commit the active document. It is modified but it's file attribute is read only."
Public Const gmsgCommitAskSaveMod As String = "The active document is modified. Do you save it?"
Public Const gmsgCommitAskSaveModCloseReopen As String = "Once the active document file is closed, and reopened after committing. The active document is modified. Do you save it?"
Public Const gmsgLockAskActiveContentFileReadOnly As String = "The active document is modified but it's file attribute is read only. Do you wish to abort getting lock? If you select [No], the changes are discarded and continue to get lock."
Public Const gmsgLockAskSaveModContent As String = "Once the active document file is closed, and reopened after getting lock. The active document is modified. Do you save it?"
Public Const gmsgUnlockErrActiveContentFileReadOnly As String = "Can't release lock of the active document. It is modified but it's file attribute is read only."
Public Const gmsgUnlockAskActiveContentMod As String = "The active document is modified. You can't put the changes into the repository by releasing lock. Do you continue?"
...
Public Const gmsgErrActiveContentFileNotExist As String = "Can't find the active document file. Save the active document and retry. "
Public Const gmsgErrFolderNotUnderCtrl As String = "The active document file is not in the folder under version control."
Public Const gmsgErrFileNotUnderCtrl As String = "The active document file is not under version control."
...
Public Const gmsgAskSaveMod As String = "The active document is modified. Do you save it?"
