...
Public Const gmsgCommitAskSaveModContent As String = "Once the active document file is closed, and reopened after committing. The active document is modified. Do you save it?"
...
Public Const gmsgUnlockAskActiveContentMod As String = "The active document is modified. You can't put the changes into the repository by realeasing lock. Do you continue?"
