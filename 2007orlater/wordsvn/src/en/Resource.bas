...
Public Const gmsgAskLockMod As String = "The active document is under control of svn and has needs-lock property. It has been modified. Do you wish to lock it?"
